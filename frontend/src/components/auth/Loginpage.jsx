     ...
     w-full flex items-center justify-center
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="bg-white/90 backdrop-blur-sm
         rounded-2xl shadow-card px-10 py-10">

          <div className="text-center mb-8">
            <h1 className="text-5xl font-bold 
            font-montserrat text-accent leading-tight">
              Hospital
            </h1>
          ...
          <form onSubmit={formik.handleSubmit} noValidate className="space-y-5">
            ...
            <button
              ...
              className="w-full py-3.5 mt-2 rounded-xl bg-primary hover:bg-primary-light active:bg-primary-dark
                         ...
                         transition-all duration-200 transform hover: cursor-pointer -translate-y-0.5 active:translate-y-0
